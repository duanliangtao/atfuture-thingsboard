 ...
 */
export default angular.module('thingsboard.api.deviceManagement', [])
    .factory('deviceManagementService', DeviceManagementService)
    .name;

/*@ngInject*/
function DeviceManagementService($http, $q) {
